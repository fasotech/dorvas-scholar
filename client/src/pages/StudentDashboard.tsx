    ...
    <div className="bg-[#f4f7f6] min-h-screen pb-12 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-10 relative z-20">
        <div className="bg-white rounded-2xl shadow-xl p-4 md:p-6 grid grid-cols-3 md:grid-cols-6 gap-4 border border-gray-100">
          <ActionBtn icon={BookOpen} label="Subjects" color="text-blue-600" bg="bg-blue-50" border="border-blue-100" hover="hover:bg-blue-600 hover:text-white" />
          <ActionBtn icon={FileText} label="Assignments" color="text-amber-600" bg="bg-amber-50" border="border-amber-100" hover="hover:bg-amber-600 hover:text-white" />
          <ActionBtn icon={CheckSquare} label="CBT Exams" color="text-rose-600" bg="bg-rose-50" border="border-rose-100" hover="hover:bg-rose-600 hover:text-white" />
          <ActionBtn icon={PlayCircle} label="eClassroom" color="text-emerald-600" bg="bg-emerald-50" border="border-emerald-100" hover="hover:bg-emerald-600 hover:text-white" />
          <ActionBtn icon={CreditCard} label="My Invoices" color="text-purple-600" bg="bg-purple-50" border="border-purple-100" hover="hover:bg-purple-600 hover:text-white" />
          <ActionBtn icon={UserSquare2} label="ID Card" color="text-indigo-600" bg="bg-indigo-50" border="border-indigo-100" hover="hover:bg-indigo-600 hover:text-white" />
        </div>
      </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="border-b px-8 py-4 flex gap-8 text-sm font-bold text-gray-400 overflow-x-auto bg-gray-50/50">
              <span className="text-[#1b4332] border-b-2 border-[#1b4332] pb-4 -mb-4 transition-colors cursor-pointer">Overview</span>
              <span className="hover:text-gray-900 transition-colors cursor-pointer">Attendance</span>
              <span className="hover:text-gray-900 transition-colors cursor-pointer">Result</span>
              <span className="hover:text-gray-900 transition-colors cursor-pointer">Medical</span>
              <span className="hover:text-gray-900 transition-colors cursor-pointer">Remarks</span>
            </div>
...
function ActionBtn({ icon: Icon, label, color, bg, border, hover }: { icon: any, label: string, color: string, bg: string, border: string, hover: string }) {
  return (
    <div className={`flex flex-col items-center justify-center p-4 bg-white cursor-pointer transition-all duration-300 border ${border} rounded-xl shadow-sm text-center group hover:-translate-y-1 hover:shadow-md`}>
